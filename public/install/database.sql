...
CREATE TABLE `episodes` (
  ...
  `video_url_480` longtext COLLATE utf8mb4_unicode_ci,
  `video_url_720` longtext COLLATE utf8mb4_unicode_ci,
  `video_url_1080` longtext COLLATE utf8mb4_unicode_ci,
...
CREATE TABLE `settings` (
  ...
  `google_redirect` text COLLATE utf8_unicode_ci,
  ...
  `facebook_redirect` text COLLATE utf8_unicode_ci,
...
(1, 'Asia/Kolkata', 'en', 'light', 'Viavi Streaming - Watch TV Shows, Movies  Online', 'info@viaviweb.com', 'logo.png', 'favicon.png', 'Viavi Streaming is Best Script for Streaming Website & Application | Streaming App | Streaming Script | TV Streaming Source Code | TV Clone | Netflix Clone | Amazon Prime Clone | Hotstar Clone | Streaming App', 'Video Streaming,Streaming Website,Streaming App,Live TV, Movies, TV Shows', '', '', 'Copyright Â© 2019 www.viaviweb.com. All Rights Reserved.', 'USD', 0, 'sandbox', NULL, NULL, 0, NULL, NULL, 0, NULL, NULL, 0, NULL, NULL, 'https://www.facebook.com/viaviweb/', 'https://twitter.com/viaviwebtech/', 'https://www.instagram.com/viaviwebtech/', 'https://play.google.com/store/apps/dev?id=7157478532572017100', 'https://apps.apple.com/in/developer/vishal-pamar/id1141291247', '', '', '', '', 'TLS', 'This website is using cookies', 'We use them to give you the best experience. If you continue using our website, we\\\'ll assume that you are happy to receive all cookies on this website.', '#', '', 'CDN', '0', '0', NULL, NULL, 'http://localhost/laravel_video_script_update/auth/google/callback', NULL, NULL, 'http://localhost/laravel_video_script_update/auth/facebook/callback', '', '', '');
...
(1, 'Admin', 0, NULL, NULL, 'Viavi Webtech', 'admin@admin.com', '$2y$10$EMeDkbAwIXJd7fAX0pWF2OZCHmKuGMwtD3ZUjg9HEOMvkaVl.5Xvm', '9227777522', NULL, 'viavi-webtech-1f2416ecff3faba4159de6b399477081-b.jpg', 1, 2, 0, 2592000, NULL, NULL, NULL, NULL, '0.00', NULL, 'es7sdINZ9kPm5uFlBaq0VFk1WoO1ppFFOENRqhfpwhC89jqDnHptmKqEdeLN', 'iXL5Efee1FhfiXQzxPTe2PzEfFqU3seM3b6TzvU7', '2020-03-12 15:16:45', '2020-09-10 03:39:58');
