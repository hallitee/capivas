                  ...
                  <div class="col-sm-3">
                     <select class="form-control" name="gateway_select" id="gateway_select">
                        <option value=""><?php echo e(trans('words.filter_by_gateway')); ?></option>
                          ...
                          <option value="?gateway=Paystack" <?php if(isset($_GET['gateway']) && $_GET['gateway']=='Paystack' ): ?> selected <?php endif; ?>>Paystack</option>
                          <option value="?gateway=Razorpay" <?php if(isset($_GET['gateway']) && $_GET['gateway']=='Razorpay' ): ?> selected <?php endif; ?>>Razorpay</option>
...
<?php echo $__env->make("admin.admin_app", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\viaviweb\resources\views/admin/pages/transactions_list.blade.php ENDPATH**/ ?>