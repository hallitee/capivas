            ...
            <div class="col-md-9 col-sm-8">
              <div class="col-md-6 col-sm-6">
                <div class="member-ship-option">
                  ...
                  <div> 
                      <a href="<?php echo e(URL::to('membership_plan')); ?>" class="member-a" onclick=""><?php echo e(trans('words.select_plan')); ?> </a>
                  </div>
...
<?php echo $__env->make('site_app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\viaviweb\resources\views/pages/dashboard.blade.php ENDPATH**/ ?>