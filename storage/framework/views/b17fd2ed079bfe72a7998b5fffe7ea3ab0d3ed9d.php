 ...
 <div class="page-header">
  <div class="vfx_page_header_overlay">
    <div class="container">
      ...
      <li><?php echo e(trans('words.tv_show_languages')); ?></li>
      </ul>  
    </div>
    </div>
  </div>
      ...
      <div class="row">
        ...
        <div class="col-md-2 col-sm-3 col-xs-6 sm-top-30">
          ...
          <div class="b-language"> 
            <a href="<?php echo e(URL::to('language/series/'.$lang_data->language_slug)); ?>">
              <div class="language_text_block">
                <h3 class="name"><?php echo e(stripslashes($lang_data->language_name)); ?></h3>              
              </div>
...
<?php echo $__env->make('site_app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\viaviweb\resources\views/pages/series_language.blade.php ENDPATH**/ ?>