    ...
    <div class="container">
        ...
        <div class="col-md-6 col-sm-4 col-xs-12">
          <div class="member-ship-option select_plan">
            ...
            <p><?php echo e(getcong("currency_code")." ".number_format($plan_info->plan_price)); ?></p>
        ...
        <div class="col-md-6 col-sm-4 col-xs-12">
          ...
          <input type="hidden" name="amount" value="<?php echo e($plan_info->plan_price); ?>">
          <div class="member-ship-option select_plan">
...
<?php echo $__env->make('site_app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\viaviweb\resources\views/pages/payment_method.blade.php ENDPATH**/ ?>