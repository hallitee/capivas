		  ...
		  <div class="upcomming-details">
			<div class="col-md-6">
			  ...
			  <?php endif; ?>  
				  ...
				  <?php echo e(stripslashes($series_info->series_name)); ?></a></h4>

			  <?php else: ?>
			  <h4 class="video-title"><a href=""><?php echo e(stripslashes($series_info->series_name)); ?></a></h4>
			  <?php endif; ?>
        ...
        <div class="owl-carousel video-carousel" id="video-carousel">
          ...
          <div class="vfx_video_item">
            ...
            <div class="vfx_video_detail">
              <h4 class="vfx_video_title"><?php echo e(Str::limit(stripslashes($season_data->season_name),20)); ?></h4>
             </div>
          </div>
          </a>
          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>                
...
<?php echo $__env->make('site_app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\viaviweb\resources\views/pages/series_single.blade.php ENDPATH**/ ?>