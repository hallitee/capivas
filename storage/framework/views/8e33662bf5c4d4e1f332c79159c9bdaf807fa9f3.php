<?php $__env->startSection('head_title', $genres_info->genre_name.' '.trans('words.tv_shows_text').' | '.getcong('site_name') ); ?>
    ...
    <div class="container">
      ...
      <div class="col-md-3 col-sm-4 col-xs-6 sm-top-30">
        ...
        <div class="vfx_upcomming_detail">
          <h4 class="vfx_video_title"><?php echo e(Str::limit(stripslashes($series_data->series_name),20)); ?></h4>          
        </div>            
        </div>                  
      </div>
      </a>
...
<?php echo $__env->make('site_app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\viaviweb\resources\views/pages/series_by_genres.blade.php ENDPATH**/ ?>