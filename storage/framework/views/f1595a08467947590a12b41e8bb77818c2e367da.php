            ...
            <div class="row">
              <div class="col-lg-8 col-md-8"> 
                <h4 class="banner-title">
                  ...
                  <?php if($slider_data->slider_type=="Movies"): ?>
                  <a class="" href="<?php echo e(URL::to('movies/'.App\Movies::getMoviesInfo($slider_data->slider_post_id,'video_slug').'/'.$slider_data->slider_post_id)); ?>">
                      <?php echo e(stripslashes($slider_data->slider_title)); ?>
                  ...
                  <?php else: ?>
                    <a href="#"><?php echo e(stripslashes($slider_data->slider_title)); ?></a>
                  <?php endif; ?>                  
...
<div class="main-wrap">   
  ...
  <?php if(!empty($home_sections->section2_latest_series)): ?> 
  <div class="section section-padding bg-image tv_show gray_bg">
    <div class="container">
      <div class="row">
        <div class="col-sm-12 col-xs-6">
          ...
          <?php if(App\Series::getSeriesInfo($latest_series,'status')==1): ?>
            ...
            <div class="vfx_video_item">
			 ...
			 <div class="vfx_upcomming_detail">
			  <h4 class="vfx_video_title"><?php echo e(Str::limit(stripslashes(App\Series::getSeriesInfo($latest_series,'series_name')),25)); ?></h4>
			 </div> 
           </div>
           </a>  
          <?php endif; ?>
  ...
  <?php endif; ?>
  <?php if(!empty($home_sections->section3_popular_movie)): ?> 
    <div class="section section-padding vfx_movie_section_block">
    <div class="container">
      <div class="row">
        <div class="col-sm-12 col-xs-6">
  ...
  <?php endif; ?>
  <?php if(!empty($home_sections->section3_popular_series)): ?> 
  <div class="section section-padding bg-image tv_show gray_bg">
    <div class="container">
      <div class="row">
        <div class="col-sm-12 col-xs-6">
  ...
  <?php endif; ?>
  <?php if($home_sections_list3->count()!=0): ?> 
  ...
  <?php endif; ?>
  <?php endif; ?>
  <?php if($home_sections_list4->count()!=0): ?> 
  ...
  <?php endif; ?>
  <?php endif; ?>
  <?php if($home_sections_list5->count()!=0): ?> 
...
<?php echo $__env->make('site_app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\viaviweb\resources\views/pages/index.blade.php ENDPATH**/ ?>