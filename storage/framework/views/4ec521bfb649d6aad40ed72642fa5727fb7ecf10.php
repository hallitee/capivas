              ...
              <div class="card-box">
                ...
                <?php endif; ?>
                 ...
                 <?php echo Form::open(array('url' => array('admin/subscription_plan/add_edit_plan'),'class'=>'form-horizontal','name'=>'slider_form','id'=>'slider_form','role'=>'form','enctype' => 'multipart/form-data')); ?>  
                  ...
                  <div class="form-group row">
                    <label class="col-sm-3 col-form-label"><?php echo e(trans('words.en_vas')); ?></label>
                      <div class="col-sm-8">
                            <select class="form-control" name="plan_vas">                               
                                <option value="YES" <?php if(isset($plan_info->plan_vas) AND $plan_info->plan_vas=='YES'): ?> selected <?php endif; ?>><?php echo e(trans('words.en')); ?></option>
                                <option value="NO" <?php if(isset($plan_info->plan_vas) AND $plan_info->plan_vas=='NO'): ?> selected <?php endif; ?>><?php echo e(trans('words.den')); ?></option>                            
                            </select>
                      </div>
                  </div>
                  <div class="form-group row">
                    <label class="col-sm-3 col-form-label"><?php echo e(trans('words.vas_code')); ?>*</label>
                    <div class="col-sm-8">
                      <input type="number" name="vas_code" value="<?php echo e(isset($plan_info->vas_code) ? $plan_info->vas_code : null); ?>" class="form-control">
                    </div>
                  </div>
                  <div class="form-group row">
...
<?php echo $__env->make("admin.admin_app", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\viaviweb\resources\views/admin/pages/addeditplan.blade.php ENDPATH**/ ?>