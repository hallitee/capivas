...
$("#video_type").change(function(){         
   var type=$("#video_type").val();
      ...
      {   
        ...
        <?php if(isset($movie->id) OR isset($episode_info->id) OR isset($video_info->id)): ?>
...
<script type="text/javascript">
    ...
    $(document).on('click', '#import_movie_btn', function() {
        ...
        if (from != '' && id != '') {
            $.ajax({
                type: 'GET',
                url: "<?php echo e(URL::to('admin/find_imdb_movie')); ?>",
                ...
                success: function(response) {
                    ...
                    if (imdb_status == 'success') {
                        ...
                        $('#import_movie_btn').html('<?php echo e(trans('words.fetch')); ?>');             
...
<script type="text/javascript">
    ...
    $(document).on('click', '#import_show_btn', function() {
        ...
        if (from != '' && id != '') {
            $.ajax({
                type: 'GET',
                url: "<?php echo e(URL::to('admin/find_imdb_show')); ?>",
                data: "id=" + encodeURIComponent(id) + "&from=" + encodeURIComponent(from),
                dataType: 'json',
                beforeSend: function() {
                ...
                success: function(response) {
                    ...
                    if (imdb_status == 'success') {
                        ...
                        $('#result').html('<div class="alert alert-success alert-dismissable m-t-15"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>Data imported successfully.</div>');
                        $('#import_show_btn').html('<?php echo e(trans('words.fetch')); ?>');             
...
<script type="text/javascript">
    ...
    $(document).on('click', '#import_episode_btn', function() {
        ...
        if (from != '' && id != '') {
            $.ajax({
                type: 'GET',
                url: "<?php echo e(URL::to('admin/find_imdb_episode')); ?>",
                data: "id=" + encodeURIComponent(id) + "&from=" + encodeURIComponent(from),
                dataType: 'json',
                beforeSend: function() {
                ...
                success: function(response) {
                    ...
                    if (imdb_status == 'success') {
                        ...
                        $('#result').html('<div class="alert alert-success alert-dismissable m-t-15"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>Data imported successfully.</div>');
                        $('#import_episode_btn').html('<?php echo e(trans('words.fetch')); ?>');             
...
</html><?php /**PATH C:\xampp\htdocs\viaviweb\resources\views/admin/admin_app.blade.php ENDPATH**/ ?>