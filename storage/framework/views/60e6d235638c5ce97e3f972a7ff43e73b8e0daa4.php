                ...
                <?php if(count($errors) > 0): ?>
                 ...
                 <?php echo Form::open(array('url' => array('admin/language/add_edit_language'),'class'=>'form-horizontal','name'=>'category_form','id'=>'category_form','role'=>'form','enctype' => 'multipart/form-data')); ?>  
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <input type="text" name="language_name" value="<?php echo e(isset($lang->language_name) ? stripslashes($lang->language_name) : null); ?>" class="form-control">
                    </div>
                  </div>
                  <div class="form-group row">
...
<?php echo $__env->make("admin.admin_app", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\viaviweb\resources\views/admin/pages/addeditlanguage.blade.php ENDPATH**/ ?>