              ...
              <div class="card-box">
                ...
                <?php endif; ?>
                 ...
                 <small id="emailHelp" class="form-text text-muted">For more info <a href="https://support.paystack.com/hc/en-us/articles/360009881600-Paystack-Test-Keys-Live-Keys-and-Webhooks" target="_blank">click here</a></small>
                  <div class="form-group row">
                    <label class="col-sm-3 col-form-label"><?php echo e(trans('words.paystack_payment')); ?></label>
                      <div class="col-sm-8">
                            <select class="form-control" name="paystack_payment_on_off">                               
                                 
                                <option value="1" <?php if($settings->paystack_payment_on_off=="1"): ?> selected <?php endif; ?>>ON</option>
                                <option value="0" <?php if($settings->paystack_payment_on_off=="0"): ?> selected <?php endif; ?>>OFF</option>
                                              
                            </select>
                      </div>
                  </div>
                  <div class="form-group row">
                    <label class="col-sm-3 col-form-label"><?php echo e(trans('words.paystack_secret_key')); ?></label>
                    <div class="col-sm-8">
                      <input type="text" name="paystack_secret_key" value="<?php echo e(isset($settings->paystack_secret_key) ? $settings->paystack_secret_key : null); ?>" class="form-control">
                    </div>
                  </div>
                  <div class="form-group row">
                    <label class="col-sm-3 col-form-label"><?php echo e(trans('words.paystack_public_key')); ?></label>
                    <div class="col-sm-8">
                      <input type="text" name="paystack_public_key" value="<?php echo e(isset($settings->paystack_public_key) ? $settings->paystack_public_key : null); ?>" class="form-control">
                    </div>
                  </div>
...
<?php echo $__env->make("admin.admin_app", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\viaviweb\resources\views/admin/pages/payment_settings.blade.php ENDPATH**/ ?>