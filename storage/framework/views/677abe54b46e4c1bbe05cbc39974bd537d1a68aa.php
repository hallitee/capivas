            ...
            <div class="col-lg-12">
              <div class="card-box">
                ...
                <?php endif; ?>
                 ...
                 <?php echo Form::open(array('url' => array('admin/about_page'),'class'=>'form-horizontal','name'=>'settings_form','id'=>'settings_form','role'=>'form','enctype' => 'multipart/form-data')); ?>  
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <textarea id="elm1" name="page_content" class="form-control"><?php echo e(isset($page_info->page_content) ? stripslashes($page_info->page_content) : null); ?></textarea>
...
<?php echo $__env->make("admin.admin_app", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\viaviweb\resources\views/admin/pages/about_page.blade.php ENDPATH**/ ?>