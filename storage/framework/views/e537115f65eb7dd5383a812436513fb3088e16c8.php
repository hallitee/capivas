    ...
    <div class="container">
      <div class="vfx_breadcrumb">
		  <ul>
			...
			<li><?php echo e(trans('words.movies_text')); ?></li>
		  </ul>       
	  </div>	  
    </div>
  </div>
      ...
      <div class="col-md-2 col-sm-4 col-xs-6">
          ...
          <i class="icon fa fa-play"></i><span class="ripple"></span>
              ...
              <div class="vfx_video_detail">
                <h4 class="vfx_video_title"><a href="<?php echo e(URL::to('movies/'.$movies_data->video_slug.'/'.$movies_data->id)); ?>"><?php echo e(Str::limit(stripslashes($movies_data->video_title),12)); ?></a></h4>
...
<?php echo $__env->make('site_app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\viaviweb\resources\views/pages/movies.blade.php ENDPATH**/ ?>