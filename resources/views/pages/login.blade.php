...
<div class="container">
  <div class="col-md-6">
    ...
    <div class="vfx_account_wrap">
      ...
      <div class="socail-login-item">
        ...
        <label>
          <a href="{{ url('auth/google') }}" class="btn btn-lg btn-success btn-block btn-g-plus-item">
        ...
        <label>
          <a href="{{ url('auth/facebook') }}" class="btn btn-lg btn-success btn-block btn-facebook-item">
  ...
  <div class="col-md-6">
    <div class="vfx_account_wrap" id="goto_signup">
      ...
      <div class="basic-field">
        <label>
          <p><input type="text" name="name" value="{{old('name')}}" placeholder="{{trans('words.name')}}" ></p>
        </label>
        <label>    
        <label>
